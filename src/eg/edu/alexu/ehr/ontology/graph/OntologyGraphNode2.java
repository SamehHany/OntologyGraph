 ...
 */
public class OntologyGraphNode2 {
    ...
    public OntologyGraphNode2(OntologyObject object) {
        this.object = object;
        setNodeType(object);
        label = "";
        EdgeType edgeType = EdgeType.PROPERTY;
        classRelations = (List<OntologyGraphEdge>[]) (new List[edgeType.
                noOfValues()]);
     ...
     * }
     */
    /*public OntologyGraphNode2(OntologyObject object, String label) {
        this.object = object;
        setNodeType(object);
        this.label = label;
        EdgeType edgeType = EdgeType.PROPERTY;
    ...
    public OntologyGraphNode2(String uri, String label, boolean isClass) {
        if (isClass) {
            object = new OntologyClass(uri);
        } else {
            object = new OntologyDatatype(uri);
    ...
    public Set<OntologyGraphEdge> getEdges() {
        Set<OntologyGraphEdge> set = new HashSet<OntologyGraphEdge>(allEdges.
                size());
    ...
    public boolean equals(Object obj) {
        if (object.isEntity()) {
            return ((OntologyObjectType) object).getURIAsStr().equals(
                    ((OntologyObjectType) ((OntologyGraphNode) obj).object).
                    getURIAsStr());
        } else {
